...
export const metadata: Metadata = {
  ...
  description: 'Step inside KoSa Beach Resort virtual tour of suites, spa, pool and shoreline in Elmina, Ghana',
};
  ...
  return (
    <>
      <PageHero
        ...
        image="https://ubsgvfouroqkgqufzeat.supabase.co/storage/v1/object/public/kosa-public/media/virtual-tour/vt-hero-common-spaces.webp"
        height="sm"
      />
