...
export const metadata: Metadata = {
  ...
  description: 'Reserve your stay at KoSa Beach Resort secure booking, best-rate guarantee, instant confirmation',
};
  ...
  return (
    <>
      <PageHero
        ...
        image="https://ubsgvfouroqkgqufzeat.supabase.co/storage/v1/object/public/kosa-public/media/book/book-welcome-arrival.webp"
        height="sm"
      />
